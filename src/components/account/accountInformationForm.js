    ...
    render() {
        ...
        return(
            <form onSubmit={handleSubmit} className={`${className} account-information-form`}>
                ...
                <Field className="account-information-form__email" type="email" title="E-Mail" placeholder="e-mail" name="email" component={FormInput}/>
...

                {
                    ...
                    [
                        <Field key={0} className="account-information-form__current" type="password" title="Current Password" placeholder="Current Password" name="current" component={FormInput}/>,
                        ...
                        <Field key={5}className="account-information-form__cancel" onClick={() => this.setState({showPasswords: false})} type="button" short={true} title="Cancel" name="cancel" component={FormButton}/>
        
                    ]
                    : 
                    <Field className="account-information-form__change-password" onClick={() => this.setState({showPasswords: true})} type="button" labelTitle="Password" title="Change Password" name="change-password" component={LongGrayButton}/>
